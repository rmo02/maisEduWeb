...
export function Navbar() {
  return(
    <div className="w-full h-16 py-3 px-52 bg-blue-600 flex justify-between items-center mb-2">
      <div>
        <a href="/home"><img className="w-15 h-8" src={Logo} alt="" /></a>
      </div>
      <div>
        <ul className="flex text-slate-100 ">
          <li className="w-full h-full px-2"><a href="/home" className="text-lg font-medium">Dashboard</a></li>
          <li className="w-full h-full px-2"><a href="/disciplinas" className="text-lg font-medium">Turmas</a></li>
          <li className="w-full h-full px-2"><a href="/progresso" className="text-lg font-medium">Progresso</a></li>
          <li className="w-full h-full px-2"><a href="/chat" className="text-lg font-medium">Chat</a></li>
        </ul>
      </div>
          ...
          <PopoverContent className="w-52 pt-2 pb-0">
            <div className="flex flex-col">
              ...
              <div className="flex justify-start items-center gap-2 mb-2">
                ...
                <a href="/config"><p className="text-sm text-slate-600 font-semibold">Notificações</p></a>
              </div>
              <div className="flex justify-start items-center gap-2 mb-2">
